...
```{r quality score analysis, echo=FALSE}

ninetyDaysAgo <- today() - days(90)

chunk12_body <- statement(select=c("Date","Criteria","HasQualityScore","CreativeQualityScore","PostClickQualityScore","SearchPredictedCtr","QualityScore"),
